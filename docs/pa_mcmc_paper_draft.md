...
| Elongated Gaussian 5D (κ=100) | σ₁=0.1, σ₂₋₅=1.0 | 458.1 | 1491.2 | 1669.9 | 85% |
...
**Convergence verification.** For the 2D Elongated Gaussian, the payload u converges from the initial σ=10 to u₁ ≈ 0.302 and u₂ ≈ 3.68 (theoretical target 0.238 and 2.38 — within convergence tolerance at N=10,000), consistent with Theorem 6.1. Both dimensions separate correctly — the joint proposal bottleneck identified in Section 5 is resolved by per-dimension updates.
