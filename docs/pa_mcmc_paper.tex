...
Both parameters measure the same conserved quantity: the number of uncertainty
dimensions that survive a compression or multiplication operation.
\end{lemma}
...
of \citet{roberts2009examples}, ensuring ergodicity of the full chain.
...
ESS gain scales with the \emph{degeneracy fraction} $d_{\mathrm{degen}}/d$: as $d$
increases with fixed degenerate subspace dimension, gains decrease
(56$\times$ at 2D, 28$\times$ at 10D).
...
\begin{figure}[h]
\centering
% \includegraphics[width=0.8\textwidth]{fig_rosenbrock_trajectories.pdf}
...
\begin{figure}[h]
\centering
% \includegraphics[width=0.8\textwidth]{fig_ess_scaling.pdf}
...
\begin{figure}[h]
\centering
% \includegraphics[width=0.8\textwidth]{fig_efficiency_per_eval.pdf}
...
\begin{figure}[h]
\centering
% \includegraphics[width=0.8\textwidth]{fig_multimodal_boundary.pdf}
...
The DESI posterior with Planck priors has condition number ${\sim}5$
(mild, not severely degenerate).
